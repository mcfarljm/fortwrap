...
def write_matrix_class():
    ...
    f.write('  ' + matrix_classname + '(std::size_t m, std::size_t n, T *data_ptr) {\n')
    ...
    f.write('  T& operator()(std::size_t i, std::size_t j) {\n')
    ...
    f.write('  inline std::size_t num_rows(void) const { return nrows; }\n\n')
    write_cpp_dox_comments(f, ['Get number of columns'])
    f.write('  inline std::size_t num_cols(void) const { return ncols; }\n\n')
    f.write('};\n\n')
